...
## get abundance
# /share/data1/Database/NCBI/Fungi.2024/01.human_correlative/index/assign.scale_by_length.py ${step5_data} ${step6_data} 0.95
/share/data1/Database/NCBI/Fungi.2024/01.human_correlative/index/GPA.py -i ${step5_data} -o ${step6_data} -s 0.95
